...
cmax_range <- runif(min = 1, max = 10, n = times)
save_cmax <- tibble(Iteration = 1:times, cmax = cmax_range)
...
write.csv(save_cmax, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_list.csv")
write.csv(salmon_eaten_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps,"ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_cmax_seals_harvested_output.csv")

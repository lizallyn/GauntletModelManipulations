...
range_efficiency <- runif(min = 0, max = 0.5, n = times)
...
for(rep in 1:times){
  ...
  fear <- "Fear"
  participation <- 1
  catchability <- range_efficiency[rep]
  overlap_pv <- 0.5
  ...
  # save harvest plan for Ch 1 During timing
  # write.csv(x = boat_days, file = "ParameterManipulations/Outputs/harvest_days_during_Ch1.csv")
...
write.csv(range_efficiency, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_range_efficiency.csv")
write.csv(salmon_eaten_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "ParameterManipulations/Outputs/Reps_Fear_Harvest_Efficiency_seals_harvested_output.csv")

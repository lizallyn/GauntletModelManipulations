...
range_days <- sample(0:7, times, replace = TRUE)
...
write.csv(range_days, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_range_days.csv")
write.csv(salmon_eaten_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "ParameterManipulations/Outputs/Reps_Fear_Weekly_Effort_seals_harvested_output.csv")

...
rho_range <- runif(min = 0, max = 0.3, n = times)
save_rho <- tibble(Iteration = 1:times, rho = rho_range)
...
write.csv(save_rho, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_list.csv")
write.csv(salmon_eaten_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps,"ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_rho_seals_harvested_output.csv")

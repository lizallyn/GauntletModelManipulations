...
learn_rate_range <- runif(min = 0.01, max = 0.3, n = times)
save_learn_rate <- tibble(Iteration = 1:times, learn_rate = learn_rate_range)
...
for(rep in 1:times){
  ...
  # source("CopyOfRunTheModel/Choose_Harvest_Options.R")
  ...
  # reset pars
  learn_rate <- learn_rate_range[rep]
...
write.csv(save_learn_rate, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_list.csv")
write.csv(salmon_eaten_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps,"ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_seals_harvested_output.csv")

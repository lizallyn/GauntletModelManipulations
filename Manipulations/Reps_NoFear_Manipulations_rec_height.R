...
rec.height_range <- runif(min = 0, max = 1, n = times)
save_rec_height_fear <- tibble(Iteration = 1:times, rec_height = rec.height_range)
...
for(rep in 1:times){
  ...
  # reset pars
  rec.height <- rec.height_range[rep]
...
write.csv(save_rec_height_fear, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_list.csv")
write.csv(salmon_eaten_reps, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps,"ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "ParameterManipulations/Outputs/Reps_NoFear_Manipulations_rec_height_seals_harvested_output.csv")

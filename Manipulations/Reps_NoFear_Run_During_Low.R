...
write.csv(salmon_eaten_reps, "Outputs/Reps_NoFear_Run_During_Low_salmon_eaten_output.csv")
write.csv(salmon_escaped_reps, "Outputs/Reps_NoFear_Run_During_Low_salmon_escaped_output.csv")
write.csv(salmon_list_reps, "Outputs/Reps_NoFear_Run_During_Low_gauntlet_salmon_output.csv")
write.csv(salmon_consumed_pv_reps, "Outputs/Reps_NoFear_Run_During_Low_consumed_per_output.csv")
write.csv(gauntlet_seals_reps, "Outputs/Reps_NoFear_Run_During_Low_gauntlet_seals_output.csv")
write.csv(seal_prob_gauntlet_reps, "Outputs/Reps_NoFear_Run_During_Low_prob_gauntlet_output.csv")
write.csv(seals_harvested_reps, "Outputs/Reps_NoFear_Run_During_Low_seals_harvested_output.csv")

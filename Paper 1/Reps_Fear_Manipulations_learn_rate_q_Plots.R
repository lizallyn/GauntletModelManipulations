...
source("ParameterManipulations/plotSeals.R")
source("ParameterManipulations/plotSealsValue.R")
source("ParameterManipulations/plotConsumedDaily.R")

times <- 100
read.learn_rate <- read.csv("ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.1_list.csv")
learn_rate_range <- read.learn_rate$learn_rate

# Salmon Eaten

read.eaten_q0.1 <- read.csv("ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.1_salmon_eaten_output.csv")
colnames(read.eaten_q0.1) <- c("Iteration", "Eaten")
read.eaten_q0.1$Value <- learn_rate_range
read.eaten_q0.1$q <- 0.1

read.eaten_q0.3 <- read.csv("ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.3_salmon_eaten_output.csv")
colnames(read.eaten_q0.3) <- c("Iteration", "Eaten")
read.eaten_q0.3$Value <- learn_rate_range
read.eaten_q0.3$q <- 0.3

read.eaten_q0.5 <- read.csv("ParameterManipulations/Outputs/Reps_Fear_Manipulations_learn_rate_q0.5_salmon_eaten_output.csv")
